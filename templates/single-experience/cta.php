...
?>
<section class="pw-experience-cta" aria-labelledby="pw-experience-cta-heading-<?php echo esc_attr( (string) $post_id ); ?>">
	<?php do_action( 'pw_before_experience_cta_content', $post_id ); ?>
	<h2 class="pw-experience-cta__heading" id="pw-experience-cta-heading-<?php echo esc_attr( (string) $post_id ); ?>">
		<?php echo esc_html( pw_get_cta_label( 'pw_experience', $post_id ) ); ?>
	</h2>
	<p class="pw-experience-cta__action">
		<a class="pw-experience-cta__link" href="<?php echo esc_url( $href ); ?>">
			<?php echo esc_html( pw_get_cta_label( 'pw_experience', $post_id ) ); ?>
		</a>
	</p>
	<?php do_action( 'pw_after_experience_cta_content', $post_id ); ?>
</section>
